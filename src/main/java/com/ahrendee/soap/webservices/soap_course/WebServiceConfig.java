...
public class WebServiceConfig {
    ...
    @Bean(name = "courses")
    public DefaultWsdl11Definition coursesWsdl11Definition(XsdSchema coursesSchema) {
        DefaultWsdl11Definition wsdl11Definition = new DefaultWsdl11Definition();
        wsdl11Definition.setPortTypeName("CoursePort");
        wsdl11Definition.setLocationUri("/ws");
        wsdl11Definition.setTargetNamespace("http://ahrendee.com/courses");
    ...
    public SimplePasswordValidationCallbackHandler callBackHandler() {
        ...
        callBackHandler.setUsersMap(Collections.singletonMap("ronald", "roepie"));
